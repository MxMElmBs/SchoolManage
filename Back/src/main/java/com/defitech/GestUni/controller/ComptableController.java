...
@RequestMapping("/api/auth/comptable")
public class ComptableController {
    ...
    public ResponseEntity<?> ajouterEtudiant(@Valid @RequestBody StudentDto studentDto, BindingResult result) {
        ...
        studentServices.saveEtudiant(studentDto);
...
//    }
    ...
    public ResponseEntity<List<ArmelFilliereDto>> getFiliereByParcours(@PathVariable Long parcoursId) {
        List<ArmelFilliereDto> filieres = filiereServices.findByParcoursId(parcoursId);
