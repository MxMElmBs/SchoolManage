...
@Component({
  selector: 'app-cahiertextedehisto',
  standalone: true,
  imports: [CommonModule],
  templateUrl: './cahiertextedehisto.component.html',
  styleUrl: './cahiertextedehisto.component.css'
})
export class CahiertextedehistoComponent implements OnInit {
  ...
  etudiantId: number = 2; // ID de l'étudiant (à ajuster selon votre logique)
